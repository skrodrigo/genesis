...
const initialItems: Record<string, Item> = {
	...
	"app/(dashboard)/dashboard": {
		...
		children: [
			...
			"app/(dashboard)/dashboard/analytics.tsx",
	...
	"app/(dashboard)/reports": {
		name: "reports",
		children: [
			"app/(dashboard)/reports/monthly.tsx",
			"app/(dashboard)/reports/annual.tsx",
		],
	},
	"app/(dashboard)/reports/monthly.tsx": {
		name: "monthly.tsx",
	...
	"app/(dashboard)/users": {
		name: "users",
		children: [
			"app/(dashboard)/users/list.tsx",
			"app/(dashboard)/users/profile.tsx",
		],
	},
	...
	"app/api": {
		name: "api",
		children: ["app/api/hello", "app/api/user", "app/api/report"],
	},
